...
inputFile = LOAD 'hdfs:///user/Asha/inputs' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
-- rmf hdfs:///user/Asha/PigProjectOutput;

-- Store the results into folder
STORE result INTO 'hdfs:///user/Asha/PigProjectOut';
